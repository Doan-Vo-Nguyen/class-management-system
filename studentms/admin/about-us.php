...
$sql="UPDATE page SET page_title=:pagetitle,PageDescription=:pagedes WHERE  PageType='aboutus'";
...
<head>
    ...
    <title>Class Management System|| Update About Us</title>
    <!-- plugins:css -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pagetitle" value="<?php  echo $row->page_title;?>"
                                                class="form-control" required='true'>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputName1">Page Description:</label>
                                            <textarea type="text" name="pagedes" class="form-control"
                                                required='true'><?php  echo $row->page_description;?></textarea>
                                        </div>
                                        <?php $cnt=$cnt+1;}} ?>
