                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo htmlentities($row->notice_title);?></td>
                                                    <td><?php  echo htmlentities($row->notice_message);?></td>
                                                    <td><?php  echo htmlentities($row->creation_date);?></td>
                                                    <td>
                                                        <div><a
                                                                href="edit-notice-detail.php?editid=<?php echo htmlentities ($row->ID);?>"><i
                                                                    class="icon-eye"></i></a>
                                                            || <a
                                                                href="manage-notice.php?delid=<?php echo ($row->ID);?>"
