                                    ...
                                    <div class="table-responsive border rounded p-1">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $sql="SELECT * FROM student as st JOIN class as cl ON st.class_id = cl.class_id LIMIT $offset, $no_of_records_per_page";
                                                $query = $dbh -> prepare($sql);
                                                $query->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo htmlentities($row->class_name);?>
                                                        /<?php  echo htmlentities($row->class_batch);?></td>
