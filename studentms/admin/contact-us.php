...
$mobnum=$_POST['mobnum'];
$email=$_POST['email'];
$sql="UPDATE page SET page_title=:pagetitle,page_description=:pagedes,page_email=:email,page_phone=:mobnum WHERE  page_type='contactus'";
...
<head>
    ...
    <title>Class Management System|| Update Contact Us</title>
    <!-- plugins:css -->
