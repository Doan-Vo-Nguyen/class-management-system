...
$sql ="SELECT admin_id FROM admin WHERE email=:ademail and password=:cpassword";
$query= $dbh -> prepare($sql);
$query-> bindParam(':ademail', $adminEmail, PDO::PARAM_STR);
...
if($query -> rowCount() > 0)
{
    ...
    $con="UPDATE admin set password=:newpassword where admin_id=:adminid";
...
<head>
    ...
    <title>Class Management System|| Change Password</title>
    <!-- plugins:css -->
