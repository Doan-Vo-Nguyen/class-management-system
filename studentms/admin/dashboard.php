...
<head>
    ...
    <title>EduTrack - Student Management System | Dashboard</title>
    <!-- plugins:css -->
                                    ...
                                    <div class="row report-inner-cards-wrapper">
                                        <div class=" col-md -6 col-xl report-inner-card">
                                            <div class="inner-card-text">
                                                <?php 
                                                $sql1 ="SELECT DISTINCT class_specialized FROM class";
                                                $query1 = $dbh -> prepare($sql1);
                                                $query1->execute();
                                                $results1=$query1->fetchAll(PDO::FETCH_OBJ);
                                                $totclass=$query1->rowCount();
                                                ?>
                                                <span class="report-title">Total Specialized</span>
                                                <h4><?php echo htmlentities($totclass);?></h4>
                                                <a href="manage-specialized.php"><span class="report-count"> View
                                                        Specialized</span></a>
                                            </div>
