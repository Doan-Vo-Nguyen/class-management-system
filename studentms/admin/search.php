                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                if (isset($_GET['pageno'])) {
                                                  ...
                                                  $ret = "SELECT student_id FROM student";
                                                  $query1 = $dbh -> prepare($ret);
                                                  $query1->execute();
                                                  $results1=$query1->fetchAll(PDO::FETCH_OBJ);
                                                  $total_rows=$query1->rowCount();
                                                  $total_pages = ceil($total_rows / $no_of_records_per_page);
                                                  $sql="SELECT * FROM student WHERE student_id like '$sdata%' LIMIT $offset, $no_of_records_per_page";
                                                  $query = $dbh -> prepare($sql);
                                                  $query->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  echo htmlentities($row->class);?>
                                                        / <?php  echo htmlentities($row->batch);?></td>
                                                    ...
                                                    <td>
                                                        <div><a
                                                                href="edit-student-detail.php?editid=<?php echo htmlentities ($row->student_id);?>"><i
                                                                    class="icon-eye"></i></a>
                                                            |<a href="manage-students.php?delid=<?php echo ($row->student_id);?>"
