    ...
    <ul class="nav">
        <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                    ...
                    {               ?>
                    <p class="profile-name"><?php  echo htmlentities($row->admin_name);?></p>
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                <span class="menu-title">Specialized</span>
                <i class="icon-layers menu-icon"></i>
            </a>
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="manage-specialized.php"> Manage Specialized </a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="auth1">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="manage-public-notice.php"> Manage Public Notice </a>
                    </li>
                </ul>
            </div>
        </li>
