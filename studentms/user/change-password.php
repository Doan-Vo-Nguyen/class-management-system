...
<head>
    ...
    <title>EduTrack - Class Management System|| Student Change Password</title>
    <!-- plugins:css -->
    ...
    function checkpass() {
        if (document.changepassword.newpassword.value != document.changepassword.confirmpassword.value) {
            swal('Error!', 'New Password and Confirm Password field does not match', 'error');
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" name="changepassword" method="post"
                                        ...
                                        <?php include_once('./handle-password.php');?>
                                    </form>
                                </div>
                            </div>
                        </div>
