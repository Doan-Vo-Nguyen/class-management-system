...
<head>
    ...
    <title>Class Management System|| Student Forgot Password</title>
    <!-- plugins:css -->
                ...
                <div class="row flex-grow">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            ...
                            <h6 class="font-weight-light">Enter your email address and mobile number to reset password!
                            </h6>
                            <form class="pt-3" id="login" method="post" name="login">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="mobile"
                                        placeholder="Mobile Number" required="true" maxlength="10" pattern="[0-9]+">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="mt-3">
                                    <button class="btn btn-success btn-block loginbtn" name="submit"
