...
<head>
    ...
    <title>EduTrack - Class Management System|||Dashboard</title>
    <!-- plugins:css -->
    ...
    <link rel="stylesheet" href="../user/vendors/daterangepicker/daterangepicker.css">
    <link rel="stylesheet" href="../user/vendors/chartist/chartist.min.css">
